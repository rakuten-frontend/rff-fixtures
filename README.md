...
Execute the install command in the root directory of "rff-fixtures" repository.

```shell
$ cd path/to/rff-fixtures
...
This project is created on 2014-10-29 using [generator-rff](https://github.com/rakuten-frontend/generator-rff) v0.4.0.
